package com.example.spottogo.ui.register
                ...
                Button(
                    onClick = {
                        val localError = when {
                            ...
                            !agreedToPolicy -> "Please agree to the Privacy Policy"
                            else -> ""
                        }
                    ...
                    if (isLoading) {
                        ...
                        Text("CREATE ACCOUNT", fontSize = 16.sp, letterSpacing = 1.sp)
                    }
                }
            }
