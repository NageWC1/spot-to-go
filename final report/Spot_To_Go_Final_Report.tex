...
Figure~\ref{fig:screens} shows all eleven implemented screens, arranged in the order a user actually reaches them rather than a plain grid. Arrows are labelled with the specific button or link that fires the transition; screens reached by a route that does not fit the row (the branches off Login and Home) instead carry a ``Reached from...'' note in their own caption, naming the screen and control that leads to them. Every screen is built as a Jetpack Compose function using Material 3 components, styled with a single Deep Orange (\texttt{\#FF5722}) theme applied consistently across the app.
...
\shot{2.1cm}{registration page.jpeg}{Registration screen creating a new Firebase account from an email, password, and display name. (From Login: ``Register'' link.)}
...
\ganttgroup{WP3: Maps \& Location}{5}{11} \\
...
\ganttbar{Firebase Authentication (login/register)}{8}{11} \\
\ganttgroup{WP4: Detail \& Video}{10}{14} \\
\ganttbar{Restaurant detail screen}{10}{11} \\
\ganttbar{Video screen \& YouTube intent}{11}{12} \\
\ganttbar{Directions screen \& Maps intent}{12}{14} \\
\ganttgroup{WP5: Search \& UI Polish}{13}{16} \\
\ganttbar{Keyword search bar}{13}{14} \\
\ganttbar{Gemini AI natural-language search}{14}{15} \\
\ganttbar{Bottom navigation \& UI fixes}{15}{16} \\
\ganttgroup{WP6: Testing \& Writing}{14}{19} \\
\ganttbar{Manual functional testing \& bug fixes}{14}{17} \\
\ganttbar{Usability heuristic review}{16}{17} \\
\ganttbar{Final report writing}{15}{19} \\
\ganttgroup{WP7: Report \& Presentation}{19}{20} \\
\ganttbar{Report review \& polish}{19}{20} \\
\ganttbar{Presentation preparation}{19}{20}
\end{ganttchart}%
}
