...
| Phase 9 | Final report writing | FULL DRAFT COMPLETE — all sections, figures, and diagrams in place; refining presentation per supervisor feedback (Edwin's 16 August notes on Figure 8 and the Gantt chart actioned in `.tex`, pending local compile check) |
